...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Refund', fields ['batch_no']
        db.delete_unique(u'payments_refund', ['batch_no'])

        # Adding index on 'Refund', fields ['batch_no']
        db.create_index(u'payments_refund', ['batch_no'])


    def backwards(self, orm):
        # Removing index on 'Refund', fields ['batch_no']
        db.delete_index(u'payments_refund', ['batch_no'])

        # Adding unique constraint on 'Refund', fields ['batch_no']
        db.create_unique(u'payments_refund', ['batch_no'])
    ...
    models = {
        ...
        u'payments.refund': {
            ...
            'batch_no': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['orders.Order']"}),
            'trade_no': ('django.db.models.fields.CharField', [], {'max_length': '64'})
