...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.is_designer'
        db.add_column(u'accounts_profile', 'is_designer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.is_designer'
        db.delete_column(u'accounts_profile', 'is_designer')
