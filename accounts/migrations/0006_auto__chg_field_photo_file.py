...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'accounts_photo', 'file', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Photo.file'
        db.alter_column(u'accounts_photo', 'file', self.gf('django.db.models.fields.CharField')(max_length=64))
