...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'accounts_profile', 'avatar',
                      self.gf('django.db.models.fields.files.ImageField')(default='avatars/default_avatar.png', max_length=100),
                      keep_default=False)

        # Adding index on 'Profile', fields ['is_designer']
        db.create_index(u'accounts_profile', ['is_designer'])


    def backwards(self, orm):
        # Removing index on 'Profile', fields ['is_designer']
        db.delete_index(u'accounts_profile', ['is_designer'])
