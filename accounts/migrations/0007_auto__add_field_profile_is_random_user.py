...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.is_random_user'
        db.add_column(u'accounts_profile', 'is_random_user',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.is_random_user'
        db.delete_column(u'accounts_profile', 'is_random_user')
