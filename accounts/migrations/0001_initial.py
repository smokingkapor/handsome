...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_profile', (
            ...
            ('preferred_style', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ...
            ('waistline', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
    ...
    models = {
        u'accounts.profile': {
            ...
            'waistline': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
