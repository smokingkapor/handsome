...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DesignPhoto.file'
        db.alter_column(u'designs_designphoto', 'file', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'DesignPhoto.file'
        db.alter_column(u'designs_designphoto', 'file', self.gf('django.db.models.fields.CharField')(max_length=64))
