...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Design.is_selected'
        db.delete_column(u'designs_design', 'is_selected')

        # Adding field 'Design.status'
        db.add_column(u'designs_design', 'status',
                      self.gf('django.db.models.fields.CharField')(default='waiting', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Design.is_selected'
        db.add_column(u'designs_design', 'is_selected',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Design.status'
        db.delete_column(u'designs_design', 'status')
