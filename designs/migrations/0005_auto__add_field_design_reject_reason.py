...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Design.reject_reason'
        db.add_column(u'designs_design', 'reject_reason',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Design.reject_reason'
        db.delete_column(u'designs_design', 'reject_reason')
