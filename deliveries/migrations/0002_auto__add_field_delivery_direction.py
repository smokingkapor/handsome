...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Delivery.direction'
        db.add_column(u'deliveries_delivery', 'direction',
                      self.gf('django.db.models.fields.CharField')(default='send', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Delivery.direction'
        db.delete_column(u'deliveries_delivery', 'direction')
    ...
    models = {
        ...
        u'deliveries.delivery': {
            ...
            'direction': ('django.db.models.fields.CharField', [], {'default': "'send'", 'max_length': '16'}),
