...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.preferred_designer'
        db.alter_column(u'orders_order', 'preferred_designer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Order.preferred_designer'
        db.alter_column(u'orders_order', 'preferred_designer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
