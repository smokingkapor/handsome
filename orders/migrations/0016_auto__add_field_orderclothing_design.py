...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderClothing.design'
        db.add_column(u'orders_orderclothing', 'design',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['designs.Design'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderClothing.design'
        db.delete_column(u'orders_orderclothing', 'design_id')
