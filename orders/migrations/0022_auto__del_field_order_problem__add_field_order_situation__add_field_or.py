...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.problem'
        db.delete_column(u'orders_order', 'problem')
        ...
        # Adding field 'Order.usual_dress'
        db.add_column(u'orders_order', 'usual_dress',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Order.preferred_dress'
        db.add_column(u'orders_order', 'preferred_dress',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Order.problem'
        db.add_column(u'orders_order', 'problem',
        ...
        # Deleting field 'Order.usual_dress'
        db.delete_column(u'orders_order', 'usual_dress')

        # Deleting field 'Order.preferred_dress'
        db.delete_column(u'orders_order', 'preferred_dress')
    ...
    models = {
        ...
        u'designs.designclothing': {
            ...
            'wanted': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        ...
        u'orders.order': {
            ...
            'age': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            ...
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
            'preferred_designer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'designed_orders'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'preferred_dress': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'prepayment': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'price_group': ('django.db.models.fields.FloatField', [], {}),
            'promo': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['promos.Promo']", 'null': 'True', 'blank': 'True'}),
            'redesign_reason': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'report': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'situation': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'created'", 'max_length': '16'}),
            'total_price': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'usual_dress': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'weight': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'})
        },
        u'orders.orderclothing': {
            'Meta': {'object_name': 'OrderClothing'},
            'design': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['designs.Design']", 'null': 'True', 'blank': 'True'}),
            'design_clothing': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['designs.DesignClothing']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['orders.Order']"})
        },
        u'orders.province': {
