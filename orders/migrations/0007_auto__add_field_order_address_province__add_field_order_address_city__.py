...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.address_province'
        db.add_column(u'orders_order', 'address_province',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Province'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.address_city'
        db.add_column(u'orders_order', 'address_city',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.City'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.address_country'
        db.add_column(u'orders_order', 'address_country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Country'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.name'
        db.add_column(u'orders_order', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Order.phone'
        db.add_column(u'orders_order', 'phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Address.name'
        db.add_column(u'orders_address', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Address.phone'
        db.add_column(u'orders_address', 'phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.address_province'
        db.delete_column(u'orders_order', 'address_province_id')

        # Deleting field 'Order.address_city'
        db.delete_column(u'orders_order', 'address_city_id')

        # Deleting field 'Order.address_country'
        db.delete_column(u'orders_order', 'address_country_id')

        # Deleting field 'Order.name'
        db.delete_column(u'orders_order', 'name')

        # Deleting field 'Order.phone'
        db.delete_column(u'orders_order', 'phone')

        # Deleting field 'Address.name'
        db.delete_column(u'orders_address', 'name')

        # Deleting field 'Address.phone'
        db.delete_column(u'orders_address', 'phone')
