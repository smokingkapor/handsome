...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'orders_province', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'orders', ['Province'])

        # Adding model 'Town'
        db.create_table(u'orders_town', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Country'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'orders', ['Town'])

        # Adding model 'Country'
        db.create_table(u'orders_country', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.City'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'orders', ['Country'])

        # Adding model 'City'
        db.create_table(u'orders_city', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('province', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Province'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'orders', ['City'])


    def backwards(self, orm):
        # Deleting model 'Province'
        db.delete_table(u'orders_province')

        # Deleting model 'Town'
        db.delete_table(u'orders_town')

        # Deleting model 'Country'
        db.delete_table(u'orders_country')

        # Deleting model 'City'
        db.delete_table(u'orders_city')
