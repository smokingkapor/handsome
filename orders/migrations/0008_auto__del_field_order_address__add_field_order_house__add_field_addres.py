...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.house'
        db.add_column(u'orders_order', 'house',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Address.house'
        db.add_column(u'orders_address', 'house',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Order.house'
        db.delete_column(u'orders_order', 'house')

        # Deleting field 'Address.house'
        db.delete_column(u'orders_address', 'house')
