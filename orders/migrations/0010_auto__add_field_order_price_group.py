...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.price_group'
        db.add_column(u'orders_order', 'price_group',
                      self.gf('django.db.models.fields.FloatField')(default=299),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.price_group'
        db.delete_column(u'orders_order', 'price_group')
