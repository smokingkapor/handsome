...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderClothing'
        db.create_table(u'orders_orderclothing', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Order'])),
            ('design_clothing', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['designs.DesignClothing'])),
        ))
        db.send_create_signal(u'orders', ['OrderClothing'])


    def backwards(self, orm):
        # Deleting model 'OrderClothing'
        db.delete_table(u'orders_orderclothing')
