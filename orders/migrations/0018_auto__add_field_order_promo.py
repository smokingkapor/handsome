...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.promo'
        db.add_column(u'orders_order', 'promo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['promos.Promo'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.promo'
        db.delete_column(u'orders_order', 'promo_id')
