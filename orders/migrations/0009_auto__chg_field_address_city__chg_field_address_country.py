...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'orders_address', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.City'], null=True))

        # Changing field 'Address.country'
        db.alter_column(u'orders_address', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Country'], null=True))

    def backwards(self, orm):

        # Changing field 'Address.city'
        db.alter_column(u'orders_address', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['orders.City']))

        # Changing field 'Address.country'
        db.alter_column(u'orders_address', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['orders.Country']))
