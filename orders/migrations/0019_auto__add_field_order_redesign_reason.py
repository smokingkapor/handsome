...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.redesign_reason'
        db.add_column(u'orders_order', 'redesign_reason',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.redesign_reason'
        db.delete_column(u'orders_order', 'redesign_reason')
