...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.color'
        db.delete_column(u'orders_order', 'color')

        # Deleting field 'Order.age_group'
        db.delete_column(u'orders_order', 'age_group')

        # Deleting field 'Order.style'
        db.delete_column(u'orders_order', 'style')
        ...
        # Adding field 'Order.age'
        db.add_column(u'orders_order', 'age',
    ...
    def backwards(self, orm):
        # Adding field 'Order.color'
        db.add_column(u'orders_order', 'color',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=32),
                      keep_default=False)

        # Adding field 'Order.age_group'
        db.add_column(u'orders_order', 'age_group',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Order.style'
        db.add_column(u'orders_order', 'style',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Order.age'
        db.delete_column(u'orders_order', 'age')
    ...
    models = {
        ...
        u'orders.order': {
            ...
            'problem': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
