...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'orders_order', (
            ...
            ('prepayment', self.gf('django.db.models.fields.FloatField')()),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('style', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('age_group', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('height', self.gf('django.db.models.fields.CharField')(max_length=16, blank=True)),
            ('weight', self.gf('django.db.models.fields.CharField')(max_length=16, blank=True)),
            ('waistline', self.gf('django.db.models.fields.CharField')(max_length=16, blank=True)),
            ('chest', self.gf('django.db.models.fields.CharField')(max_length=16, blank=True)),
            ('hipline', self.gf('django.db.models.fields.CharField')(max_length=16, blank=True)),
            ('foot', self.gf('django.db.models.fields.CharField')(max_length=16, blank=True)),
            ('preferred_designer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='designed_orders', to=orm['auth.User'])),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('status', self.gf('django.db.models.fields.CharField')(default='created', max_length=16)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='my_orders', to=orm['auth.User'])),
